...
public class SellerFormController implements Initializable {
	...
	private void setErrorMessages(Map<String, String> errors) {
		...
		lblErrorName.setText((fileds.contains("name") ? errors.get("name") : ""));
		lblErrorEmail.setText((fileds.contains("email") ? errors.get("email") : ""));
		lblErrorBaseSalary.setText((fileds.contains("baseSalary") ? errors.get("baseSalary") : ""));
		lblErrorBirthDate.setText((fileds.contains("birthDate") ? errors.get("birthDate") : ""));
	}
